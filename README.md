...
- 官方模型、Figure、服飾、壓克力周邊、塗料等多種分類
- 中文為主標、日文原名為副標，兩者皆可搜尋
- 可依分類／機體／系列篩選，支援價格與折扣排序
- 每件商品可點擊前往青島官網或 hobbysearch 原始商品頁
- 每次更新後顯示「最近變動」：新上架、降價、漲價、庫存變動
- **阿斯拉時間軸**：歷代機體依劇中年代排列，對照作品、規格與對應周邊商品
...
| 來源 | 提供 |
|---|---|
| [青島文化教材社（官方）](https://www.aoshima-bk.co.jp/special/product/cyberformula/) | 官方定價、發售月、系列編號、JAN、商品描述 |
| [ホビーサーチ hobbysearch](https://www.1999.co.jp/) | 商品廣度、實際售價、折扣、庫存狀態 |

部分商品兩站都有，可交叉比對價格。

時間軸頁的**機體設定**（劇中年代、規格、解說）另取自
...
> 有幾個看似 bug 但其實是刻意設計的地方（例如多數商品的系列標為「未標示」）。
...
- 社群分享預覽圖（`og-*.jpg`）含阿斯拉 G.S.X 的車體圖，
  素材為 `scripts/assets/car.jpg`，著作權屬原權利人
